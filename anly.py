...
data_train, data_test, label_train, label_test = cross_validation.train_test_split(data, label,test_size=test_rate, random_state=40)#,random_state=28)#, random_state=37)
